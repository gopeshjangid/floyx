...
export default function TermsOfService() {
    ...
    return (
        <Box sx={{ m: 2 }}>
            ...
            <Typography variant="h6" color={color} gutterBottom component="div">
                General Terms
            </Typography>
            ...
            <Typography variant="h5" color={color} gutterBottom component="div">
                Privacy Policy
            </Typography>
            ...
            <Typography color={color} variant="h5" gutterBottom component="div">
                Eligibility
            </Typography>

            <Typography color={color} paragraph gutterBottom>
 ...
 <Typography color={color} variant="h5">
            Trademark Policy</Typography>
             <Typography color={color} paragraph>
“Floyx”, the Floyx logo and any other product or service names, logos, slogans that may appear on the Service are trademarks of Floyx LLC., and, may not be copied, imitated, or used, in whole or in part, unless explicitly permitted or without first receiving written permission from us to do so. The look and feel of the Service is protected by copyright. You may not duplicate, copy, or reuse any portion of the HTML/CSS, Javascript, or visual design elements or concepts without express written permission.</Typography>
