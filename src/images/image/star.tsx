...
const StarIcon = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M8 5H2" stroke="#5798FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M5 19H2" stroke="#5798FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M3 12H2" stroke="#5798FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  );
};
