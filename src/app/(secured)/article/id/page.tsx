  ...
  article: {
    ...
    content: [
      ...
      },
      {
        ...
        tooltip: false,
        type: 'paragraph',
        value:'Books are man’s best friends. Books are portable and so they are easy to carry around. And so books can be read at any time night or day, while travelling on a bus or train or flight, and at meal time too. Books are published in many languages and in varied genres',
        tooltipIcon: true,
      },
      {
        autoFocus: true,
        ...
        tooltip: false,
        type: 'paragraph',
        value:'We also have story books that we read for leisure and fun. We can get them from the school library. We can also buy them from bookshops. Books are printed on paper, and can have pictures too that make them interesting. We can read books on the computer as well.',
        tooltipIcon: true,
      },
      {
        autoFocus: true,
    ...
    commentsList:[
      {
          ...
          comment: {
              ...
              content: "The discussion on AI bias is spot-on. It's a problem that demands our immediate attention, and the article does a great job.",
              numberOfLikes: 0,
              likedByAuthor: false
          }
      },
...
export default function Page() {
  return (
    <Container sx={{ width: '100%', display:'flex', justifyContent:'center', alignItems:'center' }}>
      <Box sx={{ width: '70%'}}>
        <FullArticle postDetails={ARTICLE_DETAILS} />
        <TipColumn />
        <AuthorCoulmn authorDetails={ARTICLE_DETAILS} />
        <LikesComments likesCommentsDetails={ARTICLE_DETAILS} />
      </Box>
    </Container>
  );
}
