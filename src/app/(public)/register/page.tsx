...
const RegisterPage = () => {
  ...
  return (
      <Container component="main" maxWidth="sm" sx={{pt: 10}}>
         <Typography variant='h3' gutterBottom color="textPrimary">Create your account</Typography>
          <Typography variant='h6' gutterBottom color="textPrimary">Join for free today and keep your data safe in the digital space.</Typography>
        <Box component="form" noValidate onSubmit={handleSubmit}>
            <Typography align='center' variant='body1' gutterBottom color="textPrimary">Personal account</Typography>
          <TextField
            required
            fullWidth
            id="name"
          ...
          />
          <FormControlLabel
  label="Someone reccomended Floyx to me (optional)"
  control={
    <Checkbox
      checked={true}
      onChange={()=>{}}
...
/>
          ...
          <Typography variant="body2" color="textSecondary" align="center">
              Already have an account?  <Link style={{textDecoration: 'none', color: theme?.palette.primary[theme.palette.mode]}} href="/login">
             Sign in
          </Link>
          </Typography>
        </Box>
