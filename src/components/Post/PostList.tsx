...
const PostData = [
  ...
  },
  {
    ...
    post: {
      ...
      image: {
        thumbnailPath:
          'https://s3.us-east-2.amazonaws.com/floyx-beta/post/809cfa575eac4570a5a93a3395eb8f1d.png?X-Amz-Expires=1800&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAZOGNDJSQSFOTYWIR/20231109/us-east-2/s3/aws4_request&X-Amz-Date=20231109T161153Z&X-Amz-SignedHeaders=host&X-Amz-Signature=5b8fbbb1615e963cee56204cc8f12c4609590cfc2f4a5237aee70b43bab7e846',
  ...
  },
  {
    ...
    post: {
      ...
      image: {
        thumbnailPath:
          'https://s3.us-east-2.amazonaws.com/floyx-beta/post/c4e4858dec2a4dd9a1881ef6e31534ab.png?X-Amz-Expires=1800&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAZOGNDJSQSFOTYWIR/20231109/us-east-2/s3/aws4_request&X-Amz-Date=20231109T161153Z&X-Amz-SignedHeaders=host&X-Amz-Signature=d532230e248f6b32c0e776381ddae3cc696e0183acc34915d5dd892c7109fd6c',
  ...
  },
  {
    ...
    post: {
      ...
      image: {
        thumbnailPath:
          'https://s3.us-east-2.amazonaws.com/floyx-beta/post/248059fa0406423ba8828b80ea9bd247.png?X-Amz-Expires=1800&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAZOGNDJSQSFOTYWIR/20231109/us-east-2/s3/aws4_request&X-Amz-Date=20231109T161153Z&X-Amz-SignedHeaders=host&X-Amz-Signature=30bc71fb0fdf6cdc5b8e5d89efd7e525eb08afd8a358d21fb9158834d553fc80',
  ...
  },
  {
    ...
    post: {
      ...
      image: {
        thumbnailPath:
          'https://s3.us-east-2.amazonaws.com/floyx-beta/post/70fc19fe4f734b7eb9b9b4e749cc380c.png?X-Amz-Expires=1800&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAZOGNDJSQSFOTYWIR/20231109/us-east-2/s3/aws4_request&X-Amz-Date=20231109T161153Z&X-Amz-SignedHeaders=host&X-Amz-Signature=f0ce0675c50f622813530902389a184df6f821d0f7edabeabb9152a656ede201',
      ...
      shared: {
        ...
        post: {
          ...
          link: {
            ...
            description: null,
            thumbnailPath:
              'https://floyx-beta.s3.amazonaws.com/article/075ae2133edf46708d4f1c809a82b002.png',
...
export default function PostList() {
  ...
  useEffect(() => {
    setTimeout(() => setPostData(PostData), 1000);
  }, []);
