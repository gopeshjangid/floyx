    ...
    ".articles-editor__editor": {
        ...
        ".input-item": {
            ...
            ".articles-editor__change-type": {
                ...
                border: `1px solid ${theme.palette.mode === "light" ? theme.palette?.primary?.[800] :theme.palette.primary.main}`,
                borderRadius: '4px',
                color: '#ffffff',
                display: 'inline-block',
                ...
                "&:after": {
                    ...
                    borderWidth: '8px',
                    borderStyle: 'solid',
                    borderColor: `transparent ${theme.palette?.mode === 'light' ? 'white' : "#1B1830"} transparent transparent`,
                },
                "&:before": {
                    content: "''",
                    position: 'absolute',
                    ...
                    borderWidth: '9px',
                    borderStyle: 'solid',
                    borderColor: `transparent ${theme.palette?.mode === 'light' ? "#E7F0FC" : "#5798FF"} transparent transparent`,
                },
                "& span": {
                    paddingRight: '26px',
                    cursor: 'pointer',
